...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    if (teks == '404') {
			return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
                    "listMessage":  {
                        ...
                        "description": `𝙽𝙾𝚃𝙴 📝 : 𝙱𝙾𝚃 𝙸𝙽𝙸 𝙼𝙰𝚂𝙸𝙷 𝙱𝙴𝚃𝙰, 𝙹𝙰𝙳𝙸 𝙼𝙰𝙺𝙻𝚄𝙼 𝙺𝙰𝙻𝙰𝚄 𝙱𝙰𝙽𝚈𝙰𝙺 𝙵𝙸𝚃𝚄𝚁𝙴 𝚈𝙰𝙽𝙶 𝙴𝚁𝚁𝙾𝚁, 𝙹𝙰𝙽𝙶𝙰𝙽 𝙼𝙴𝙼𝙱𝙰𝙽𝙳𝙸𝙽𝙶 𝙱𝙰𝙽𝙳𝙸𝙽𝙶𝙺𝙰𝙽 𝙼𝙰𝚂𝙸𝙽𝙶𝙱𝙾𝚃 𝙼𝙰𝙺𝙸𝙼𝙰 𝙳𝙴𝙽𝙶𝙰𝙽 𝙱𝙾𝚃 𝚈𝙰𝙽𝙶 𝙻𝙰𝙸𝙽 𝙺𝙰𝚁𝙽𝙰 𝚂𝙴𝚃𝙸𝙰𝙿 𝙱𝙾𝚃 𝙼𝙴𝙼𝙸𝙻𝙸𝙺𝙸 𝙺𝙴𝙺𝚄𝚁𝙰𝙽𝙶𝙰𝙽 𝙳𝙰𝙽 𝙺𝙴𝙻𝙴𝙱𝙸𝙷𝙰𝙽 𝙼𝙰𝚂𝙸𝙽𝙶`.trim(),
                        "footerText": "Jangan Lupa Subscribe Youtube Owner : https://youtube.com/c/Kyluesky",
                        ...
                        "sections": [
                            {
                                ...
                                "rows": [{
                                    "title": "Owner bot",
                                    "description": "Pemilik Makima ( マキマ ) ",
                                    "rowId": ".owner"
                                }, {
                                    "title": "Donasi",
    ...
    await conn.send3ButtonImg(m.chat, await (await fetch(thumbfoto)).buffer(), text.trim(), watermark, 'Pemilik Bot', `${_p}owner`, 'Donasi', `${_p}donasi`,  'Speed' , `${_p}ping`, m)
  } catch (e) {
